...
extern void CCamera__AdvanceAttributes(CCamera* pThis);
#ifdef GAME_TUROK3
#ifdef RELEASE_US
...
extern void CCamera__Advance(CCamera* pThis);
#ifdef GAME_TUROK3
#ifdef RELEASE_US
...
extern void CCamera__DisplayListSetup(CCamera* pThis);
#ifdef GAME_TUROK3
#ifdef RELEASE_US
...
extern void CCamera__DrawScene(CCamera* pThis, CScene* pScene);
#ifdef GAME_TUROK3
#ifdef RELEASE_US
...
extern void CCamera__SetupMode(CCamera* pThis, int NewMode);
#ifdef GAME_TUROK3
#ifdef RELEASE_US
...
extern void CCamera__InitializeWarp(CCamera* pThis);
#ifdef GAME_TUROK3
#ifdef RELEASE_US
...
extern void CCamera__LevelStart(CCamera* pThis);
#ifdef GAME_TUROK3
#ifdef RELEASE_US
...
extern void CCamera__Construct(CCamera* pThis);
#ifdef GAME_TUROK3
#ifdef RELEASE_US
