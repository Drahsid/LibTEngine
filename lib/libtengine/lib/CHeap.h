...
extern void* CHeap__Alloc(struct CHeap* pThis, uint32_t Length);
#ifdef GAME_TUROK3
#ifdef RELEASE_US
...
extern void* CHeap__AllocTop(struct CHeap* pThis, uint32_t Length);
#ifdef GAME_TUROK3
#ifdef RELEASE_US
...
extern void CHeap__Construct(struct CHeap* pThis, void* pAddress, uint32_t Length);
#ifdef GAME_TUROK3
#ifdef RELEASE_US
...
extern void CHeap__Dealloc(struct CHeap* pThis, void* pAddress);
#ifdef GAME_TUROK3
#ifdef RELEASE_US
...
extern void CHeap__DeallocAll(struct CHeap* pThis);
#ifdef GAME_TUROK3
#ifdef RELEASE_US
...
extern void CHeap__FreeMem(struct CHeap* pThis, uint32_t* pTotal, uint32_t* pLargest);
#ifdef GAME_TUROK3
#ifdef RELEASE_US
