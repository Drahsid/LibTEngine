...
extern void CEngineApp__AdvanceFrameData(void* pThis);
#ifdef GAME_TUROK3
#ifdef RELEASE_US
...
extern void CEngineApp__Boot(void* pThis);
#ifdef GAME_TUROK3
#ifdef RELEASE_US
...
extern void CEngineApp__ClearZBuffer(void* pThis);
#ifdef GAME_TUROK3
#ifdef RELEASE_US
...
extern void CEngineApp__Construct(void* pThis);
#ifdef GAME_TUROK3
#ifdef RELEASE_US
...
// Possibly wrong
extern void CEngineApp__DrawTextScreen(void* pThis, int bClearScreen, char** ppText, int X, int Y, int IncY, float ScaleX, float ScaleY);
#ifdef GAME_TUROK3
#ifdef RELEASE_US
...
extern void CEngineApp__Idle(void* pThis, void* pArg);
#ifdef GAME_TUROK3
#ifdef RELEASE_US
...
extern void CEngineApp__Main(void* pThis);
#ifdef GAME_TUROK3
#ifdef RELEASE_US
...
extern void CEngineApp__Retrace(void* pThis);
#ifdef GAME_TUROK3
#ifdef RELEASE_US
...
extern void CEngineApp__SetPlayers(void* pThis, int nPlayers);
#ifdef GAME_TUROK3
#ifdef RELEASE_US
...
extern void CEngineApp__SetupFadeTo(void* pThis, int Mode);
#ifdef GAME_TUROK3
#ifdef RELEASE_US
...
extern void CEngineApp__SetupGame(void* pThis);
#ifdef GAME_TUROK3
#ifdef RELEASE_US
...
extern void CEngineApp__Update(void* pThis);
#ifdef GAME_TUROK3
#ifdef RELEASE_US
