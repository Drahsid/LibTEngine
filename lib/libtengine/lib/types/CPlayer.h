...
enum WeaponId {
    ...
    WID_PISTOL              = 8,
    WID_MAG60               = 9,
    WID_SILENCEDPISTOL      = 10,
    WID_ASSAULTRIFLE        = 11,
    WID_FIRESTORMCANON      = 12,
    WID_SNIPERRIFLE         = 13,
    WID_SHOTGUN             = 14,
    WID_FIRESWARM           = 15,
    WID_SHREDDER            = 16,
    WID_VAMPIRE             = 17,
    WID_GRENADELAUNCHER     = 18,
    WID_RPG                 = 19,
    WID_NAPALMCANON         = 20,
    WID_CEREBRALBORE        = 21,
    WID_CEREBRALBURST       = 22,
    WID_CEREBRALPROCESSOR   = 23,
    WID_PSG                 = 24,
    WID_ENERGYGRAPPLE       = 25
};
