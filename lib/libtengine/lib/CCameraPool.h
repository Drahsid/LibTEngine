...
extern void CCameraPool__AddMultiLineText(struct CCameraPool* pThis, struct CCamera* pCamera, CString pString, float Secs);
#ifdef GAME_TUROK3
#ifdef RELEASE_US
...
extern void CCameraPool__AdvanceText(struct CCameraPool* pThis, struct CCamera* pCamera);
#ifdef GAME_TUROK3
#ifdef RELEASE_US
...
extern void CCameraPool__DrawScene(struct CCameraPool* pThis);
#ifdef GAME_TUROK3
#ifdef RELEASE_US
...
extern void CCameraPool__DrawTints(struct CCameraPool* pThis);
#ifdef GAME_TUROK3
#ifdef RELEASE_US
...
extern void CCameraPool__NewGame(struct CCameraPool* pThis, int nMaxCameras);
#ifdef GAME_TUROK3
#ifdef RELEASE_US
...
extern void CCameraPool__Construct(struct CCameraPool* pThis);
#ifdef GAME_TUROK3
#ifdef RELEASE_US
